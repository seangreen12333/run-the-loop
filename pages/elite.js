...
<>
  ...
  <section className="max-w-6xl mx-auto px-4 py-16 text-[#102A43] text-lg text-center">
    ...
    <p>
      Two showpiece events — one male, one female — feature the fastest runners around. These elite fields will race for
      cash, trophies, and the prestigious title of <strong>Uni Loop Champion</strong>.
    </p>
  </section>
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="md:w-1/2 text-left">
        ...
        <p className="text-lg text-gray-800 mb-4">
          Thanks to <strong>Bridging Barriers</strong>, Run The Loop will once again offer up <strong>$2,000</strong> in prize
          money to be split between podium finishers.
        </p>
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="md:w-1/2 text-left md:text-right order-2">
        ...
        <p className="text-lg text-gray-800 mb-3">
          ...
          receive a <strong>$150</strong> RunDNA voucher<sup>*</sup>.
        </p>
        <p className="text-sm md:text-base text-gray-700">
          If two or more athletes cannot be separated at the 1&nbsp;km mark, the RunDNA 1K bonus will be awarded to the
          athlete who finishes highest among the tied group at the finish line.
        </p>
      </div>
    </div>
  </section>
  ...
  <section className="bg-gray-50 py-20 px-6">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="md:w-1/2 text-left">
        ...
        <p className="text-lg text-gray-800 mb-3">
          The current women&apos;s record is held by <strong>Caitlin Adams</strong> in a time of <strong>6:47</strong>, and
          the men&apos;s record is held by <strong>Jonathan Harris</strong> in a time of <strong>5:59</strong>.
        </p>
        <p className="text-lg text-gray-800">
          Breaking one of these records will result in an extra <strong>$100</strong> bonus for the{' '}
          <em>first</em> athlete in each elite race to go under the existing mark<sup>*</sup>.
        </p>
      </div>
  ...
  {/* Footnote */}
  <p className="text-sm italic text-gray-600 max-w-6xl mx-auto px-4 pb-10">
    <sup>*</sup> Athletes must complete the race with a bona fide effort to be eligible for bonuses. Only the first
    athlete to break the course record in each race receives the Course Record Bonus. Bonuses may be awarded in the
    form of vouchers of equivalent value.
  </p>
