  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/AUA_RH_DSC08488.jpeg')",
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 text-[#102A43] text-lg">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Every finisher receives a <strong>Run the Loop finisher pin</strong>.
            </li>
            <li>
              The top three male and females in each race will receive a{' '}
              <strong>Run The Loop Medal</strong>.
            </li>
          </ul>
            ...
            <div className="space-y-6 text-[#102A43] text-lg">
              ...
              <div>
                ...
                <p className="text-slate-800">
                  ...
                  New Balance shoes valued up to{' '}
                  <span className="font-bold">$330 RRP</span>
                  <sup>*</sup>.
                </p>
              </div>
